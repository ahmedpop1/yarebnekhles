...
namespace PharmacyStock.PharmacyDBDataSetTableAdapters {
    ...
    public partial class SuppliersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Suppliers] SET [Name] = @Name, [Phone] = @Phone WHERE (([ID] = @Ori" +
                "ginal_ID));\r\nSELECT ID, Name, Phone FROM Suppliers WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PharmacyStock.Properties.Settings.Default.PharmacyDBConnectionString;
        }
        ...
        public virtual int Update(string Name, string Phone, int Original_ID, int ID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Phone, int Original_ID) {
            return this.Update(Name, Phone, Original_ID, Original_ID);
        }
    }
